      ...
      <section className="py-20">
        <div className="max-w-3xl mx-auto px-6">
            ...
            {submitted ? (
              <div className="text-center space-y-4">
                ...
                <p className="text-neutral-600">
                  Your inquiry has been received. We will respond
                  as appropriate to academic and informational requests.
                </p>
              </div>
            ) : (
          ...
          <div className="mt-16 grid md:grid-cols-3 gap-8 text-center">
            ...
            <div className="bg-white border rounded-xl p-6">
              ...
              <p className="text-neutral-600 text-sm">
                Questions related to curriculum structure
          ...
          <div className="mt-16 text-sm text-neutral-500 leading-relaxed text-center max-w-2xl mx-auto">
            ...
            It does not offer investment services, financial advice,
            brokerage accounts, or trading execution.
            Messages requesting financial advice will not receive a response.
          </div>
